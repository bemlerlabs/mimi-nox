...
|---|---|
| <video muted loop playsinline controls style="max-width:100%;border-radius:8px"><source src="docs/media/mimi-nox-demo.mp4" type="video/mp4"></video> | <video muted loop playsinline controls style="max-width:100%;border-radius:8px"><source src="docs/media/mimi-nox-mobile-qr-demo.mp4" type="video/mp4"></video> |
