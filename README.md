...
![MiMi Nox desktop demo](docs/media/mimi-nox-demo.gif)

[Download the short MP4 demo](docs/media/mimi-nox-demo.mp4)

The demo shows the local PWA flow: chat, skill input, provider settings, LAN mobile pairing, and the skills view. The demo response is generated by a local fixture for repeatable documentation capture; normal runtime uses your configured local Ollama provider.
